    ...
    return (
        <div className="App">
            ...
            <div style={{ width: "400px", borderStyle: "solid", borderColor: "black", borderWidth: "1px", justifyContent: "center", padding: "5px" }}>
                ...
                <br />
                <TextField id="outlined-basic" label="First Name" variant="outlined" onChange={e => setUser({ ...user, firstName: e.target.value })} />
                <br /> <br />
                <TextField id="outlined-basic" label="Last Name" variant="outlined" onChange={e => setUser({ ...user, lastName: e.target.value })} />
                <br /> <br />
                <TextField id="outlined-basic" label="Username" variant="outlined" onChange={e => setUser({ ...user, username: e.target.value })} />
                <br /> <br />
                <TextField id="outlined-basic" label="Session Time Out" type="number" variant="outlined" onChange={e => setUser({ ...user, session: e.target.value })} />
                <br /> <br />
                <br />
                ...
                <Button size="small" variant="contained" color="primary" onClick={addUser} >
                    Save
                </Button><br />
